   ...
   <div class="row">
      ...
      <article id="PA" class="padtop">
        ...
        <figure  class="text-center">
			<img class="img-fluid padtop img-thumbnail " src="assets/images/actualites/xiaomi.jpg" alt="Nous disposons de tous les accessoires indispensables pour votre mobile">
		</figure>
