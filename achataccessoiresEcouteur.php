    ...
    <main>
        <div class="container-fluid">
            ...
            <div id="carouselExampleIndicators" class="carousel slide mt-3 offset-md-3 col-md-6" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/images/accessoires-phone/ecouteurGallery1.jpg" class="d-block w-100"
                            alt="tel avant">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/images/accessoires-phone/ecouteurGallery2.jpg" class="d-block w-100"
                            alt="tel arriere">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-3 offset-md-3 col-md-6">
                ...
                <p class="bold">Description du produit : Ecouteur Apple </p>
                
                <p class="bold">Garantie : 1 an</p>
                <p class="bold">Prix :25€</p>
                <p class="mt-3">Paire d'écouteurs Compatible avec iPhone 7/8 iPhone X</p>
                <p>Écouteurs avec kit main libre permettant de répondre / terminer un appel 
                Mais aussi mettre en pause, de sauter et de rejouer des chansons selon vos envie . </p>
