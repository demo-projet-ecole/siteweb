   ...
   <div class="row">
      ...
      <article id="PA" class="padtop">
        ...
        <figure  class="text-center">
			<img class="img-fluid padtop img-thumbnail " src="assets/images/actualites/boutique.jpg" alt="Nous disposons de tous les accessoires indispensables pour votre mobile">
		</figure>
		  
        <p>SAFPIC met en ligne son site internet ! Un projet qui tenait à cœur à toute l’équipe, pour faire découvrir notre boutique, nos services, notre équipe et assurer une meilleure visibilité à notre entreprise.</p>
