...
<body>
    ...
    <main>
        <div class="container-fluid margbottom">
            ...
            <!--CONTAINER SIGN IN-->
            <div class="container text-center sign-in padtop">
                <form>
            ...
            <div class="container">
                ...
                <form>
                    ...
                    <div class="mb-2">
                       Titre :&nbsp;<input type="radio" name="titre" class="" value="Madame">&nbsp;Madame
                        <input type="radio" name="titre" class="" value="Monsieur">&nbsp;Monsieur
                        <input type="radio" name="titre" class="" value="Mademoiselle">&nbsp;Mlle
                    </div>
                    Prénom :
                    <div class="input-group">
                     ...
                     Nom :
                    <div class="input-group">
                       <input type="text" class="form-control my-md-2" name="text" placeholder="require">
                    </div>
                    Email :
                    <div class="input-group">
                    ...
                    Mot de passe :
                    <div class="input-group">
                        <input type="password" class="form-control my-md-2" name="password" placeholder="equired">
                    </div>
                    Mot de passe*:
                    <div class="input-group">
                        <input type="password" class="form-control my-md-2" name="password" placeholder="equired">
                    ...
                    téléphones :
                    <div class="input-group">
                       <input type="tel" maxlength="10" class="form-control my-md-2" name="tel" placeholder="require">
                    </div>
                    Adresse :
                    <div class="input-group">
                        <input type="text" class="form-control my-md-2" name="text" placeholder="required" >
            ...
            <form>
                <input type="checkbox" name="checkbox">&nbsp;J'ai pris connaissance des modalités de protection des données personelles
            </form>
            </div>
