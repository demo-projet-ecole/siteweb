...
<head>
	...
	<meta charset="UTF-8">
	<meta name="description" content="Les infos de la boutique en temps réel">
...
<div id="entete" class="position-relative">
  ...
  <div class="container">
    ...
    <h1 class="titre text-center">Les dernières infos du magasin</h1>
  </div>
			...
			<div class="col-md-4 col-xs-12 zoomphotoB">
				...
				<div class="separation">
				  <img src="assets/images/pictos/clock.png" alt="Les dernières infos"/>
					<span>21 août à 8h00</span>
				</div>

				<h2 class="titre-actu">Lancement du site internet</h2>
				<div>

					<p>MOBITEC met en ligne son site internet ! Un projet qui tenait à cœur à toute l’équipe, pour faire découvrir notre boutique, nos […]</p><br>
