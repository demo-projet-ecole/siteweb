...
<main class="indexbas">
  <div id="faq" class="container">
    ...
    <h1 class="padtop text-center padbot">Politique de confidentialité du site</h1>
    <p><strong>Qui sommes-nous ?</strong></p>
    <p>L’adresse de notre site Web est : <strong><a href="https://www.demo-projet-ecole.net/" target="_blank">https://www.demo-projet-ecole.net/</a></strong> Utilisation des données personnelles collectées</p>
    <p><strong>Formulaires de contact:</strong></p>
    <p><strong>Cookies</strong></p>
    <p>Si vous vous rendez sur l'une des pages de notre site, un cookie temporaire sera créé afin de déterminer si votre navigateur accepte ce dernier. Il ne contient pas de données personnelles et sera supprimé automatiquement à la fermeture de votre navigateur.</p>
    ...
    <p>Pour les utilisateurs et utilisatrices qui s’enregistrent sur notre site (si cela est possible), nous enregistrons également les données personnelles indiquées dans leur profil. Tous les utilisateurs et utilisatrices peuvent voir, modifier ou supprimer leurs informations personnelles à tout moment (à l’exception de leur nom d’utilisateur·ice). Les gestionnaires du site peuvent aussi voir et modifier ces informations.</p>
    <p><strong>Les droits que vous avez sur vos données</strong></p>
    <p>Si vous avez un compte, vous pouvez demander à recevoir un fichier contenant toutes les données personnelles que je possède à votre sujet, incluant celles que vous avez fournies. Vous pouvez également demander la suppression des données personnelles vous concernant. Cela ne prend pas en compte les données stockées à des fins administratives, légales ou pour des raisons de sécurité.</p>
    ...
    <p>Pour nous contacter, veuillez nous écrire à l’adresse : <a href="mailto:webmater@demo-projet-ecole.net">webmater@demo-projet-ecole.net</a></p>
  </div>
</main>
