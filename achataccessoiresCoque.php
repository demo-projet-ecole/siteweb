    ...
    <main>
        <div class="container-fluid">
            ...
            <div id="carouselExampleIndicators" class="carousel slide mt-3 offset-md-3 col-md-6" data-ride="carousel">
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="assets/images/accessoires-phone/coque noir 1.jpg" class="d-block w-100"
                            alt="tel avant">
                    </div>
                    <div class="carousel-item">
                        <img src="assets/images/accessoires-phone/coque noir 2.jpg" class="d-block w-100"
                            alt="tel arriere">
                    </div>
                </div>
            </div>
            ...
            <div class="mt-3 offset-md-3 col-md-6">
                ...
                <p class="bold">Description du produit :Coque iPhone </p>
                <p class="bold">Matieres : silicone</p>
                <p class="bold">Type de produit : Housse Standard</p>
                <p class="bold">Couleur : Noir</p>
                <p class="bold">Prix : 20€</p>

                <p class="mt-3">Protégez avec style et sobriété votre iPhone avec cette coque en silicone Apple noire !<br>
                A l'extérieur, vous retrouverez un silicone mat noir lisse et soyeux qui absorbera les chocs et évitera les rayures.<br>
                 A l'intérieur, la coque possède un revêtement en microfibre douce pour optimiser la protection de votre iPhone. 
                </p>
