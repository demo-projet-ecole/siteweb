...
<main class="indexbas">
  <div id="faq" class="container">
    ...
    <p id="Q8">Les modes de paiement suivants sont actuellement disponibles :</p>
      ...
      <ol>
        <li>
          <p>Paiement préalable : Nous réservons les articles souhaités jusqu’à sept jours à compter du passage de la commande. Vous pouvez ainsi virer ou déposer en toute facilité le montant à payer sur notre compte. Vous trouverez nos coordonnées bancaires dans la confirmation de commande que vous recevez par e-mail directement après l’envoi de votre commande. Lors du virement, veillez à ce que les données saisies soient complètes et correctes afin que nous puissions identifier correctement votre virement et que vous receviez rapidement votre commande. Dès que le montant de la facture est intégralement crédité sur notre compte, nous pouvons traiter, emballer et expédier votre commande. Nous vous en informons de nouveau par e-mail (confirmation de l’expédition). Vous recevez votre colis en règle générale sous 2 à 3 jours ouvrables</p>
        </li>
        <li>
          <p>Carte de crédit : Le mode de paiement le plus simple. Nous acceptons les cartes de crédit Visa et Mastercard. La boutique n’enregistre pas les données de votre carte de crédit</p>
        </li>
        <li>
          <p>PayPal : Vous avez un compte PayPal ? Dans ce cas, n'hésitez pas à utiliser ce mode de paiement. Sinon, ouvrez un compte PayPal sur www.paypal.fr. Ce compte vous permettra également à l'avenir de faire des achats rapidement et en toute sécurité dans de nombreuses boutiques en ligne internationales.</p>
        </li>
        <li>
          <p>Carte Bleue : Régler votre commande par Carte Bleue est très facile et confortable. Pour payer avec la Carte Bleue, sélectionnez Carte Bleue comme mode de paiement lors de l’exécution de votre commande. Via l'environnement sécurisé de Carte Bleue vous pouvez effectuer et confirmer le paiement. C'est tout, le paiement est déjà terminé.</p>
        </li>
      </ol>
    ...
    <p><b>SAFPIC Association<br>
      3 Rond-point des Acacias,<br>
      Centre équestre des 3D, 59790 RONCHIN</b></p>
