...
<p>Comment puis-je payer ?</p>
	...
	<ul>
		<ol>
			...
			<li><p>Carte de crédit : Le mode de paiement le plus simple. Nous acceptons les cartes de crédit Visa et Mastercard. La boutique n’enregistre pas les données de votre carte de crédit</p></li>
			<li><p>PayPal : Vous avez un compte PayPal ? Dans ce cas, n'hésitez pas à utiliser ce mode de paiement. Sinon, ouvrez un compte PayPal sur www.paypal.fr. Ce compte vous permettra également à l'avenir de faire des achats rapidement et en toute sécurité dans de nombreuses boutiques en ligne internationales.</p></li>
			<li><p>Carte Bleue : Régler votre commande par Carte Bleue est très facile et confortable. Pour payer avec la Carte Bleue, sélectionnez Carte Bleue comme mode de paiement lors de l’exécution de votre commande. Via l'environnement sécurisé de Carte Bleue vous pouvez effectuer et confirmer le paiement. C'est tout, le paiement est déjà terminé.</p></li>
		</ol>
	</ul>
