    ...
    <main>
        <div class="container-fluid">
            <div class="container">
                <figure class="text-center padtop">
                    <img class="text-center" src="assets/images/logos/logo-safpic-fond-transparent.png" alt="Logo de l'association SAFPIC" />
                </figure>
            </div>
		</div>
            <div class="container">
            ...
            <div class="container">
                <div class="row" id="alignPT">
                    ...
                    <!--photo smartphone-->
					 ...
					 <div class=" col-md-6 col-sm-12">
                        <figure>
                            <img src="assets/images/home/vignettes-home/achat-de-smartphone.jpg" alt="photo smartphone" class="img-thumbnail img-fluid">
                        </figure>
                    </div>
            </div>
			</div>
            ...
            <div class="container" id="LPU">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 text-center">
                        <figure class="padtop">
                            <img class="" src="assets/images/logos/logo-safpic-fond-transparent.png"
       ...
       <div class="container">
                <!--  ITEM 1-->
                    ...
                    <div class="row">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/images/home/vignettes-home/achat-accessoires-mobile.jpg"
                                        class="d-block w-100" alt="accesoire1">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/home/vignettes-home/achat-de-smartphone.jpg"
                                        class="d-block w-100" alt="accessoire1">
                                </div>
                            </div>
                            <a class="carousel-control-prev" href="#carouselaccessoire1" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselaccessoire1" role="button" data-slide="next">
                        ...
                        <div class="col-3 col-md-3 col-sm-12">
						  <article>
                            <h2 class="d-none d-lg-block sizetitle">Airpod pro</h2>
                            <p class="d-none d-lg-block">200€ - SAFPICSTORE</p>
                        ...
                        <div id="carouselaccessoire2" class="carousel slide col-md-3 col-sm-12" data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/images/home/vignettes-home/achat-accessoires-mobile.jpg"
                                        class="d-block w-100" alt="accesoire2">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/home/vignettes-home/achat-de-smartphone.jpg"
                                        class="d-block w-100" alt="accessoire2">
                                </div>
                            </div>
                            <a class="carousel-control-prev" href="#carouselaccessoire2" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselaccessoire2" role="button" data-slide="next">
                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                        </div>
                ...
                <div class="row">
                        ...
                        <div id="carouselaccessoire3" class="carousel slide col-md-3 col-sm-12 " data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/images/home/vignettes-home/achat-accessoires-mobile.jpg"
                                        class="d-block w-100" alt="accesoires3">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/home/vignettes-home/achat-de-smartphone.jpg"
                                        class="d-block w-100" alt="accesoires3">
                            ...
                            <a class="carousel-control-prev" href="#carouselaccessoire3" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselaccessoire3" role="button" data-slide="next">
                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                        </div>
                        ...
                        <div id="carouselaccessoire4" class="carousel slide col-md-3 col-sm-12 " data-ride="carousel">
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="assets/images/home/vignettes-home/achat-accessoires-mobile.jpg"
                                        class="d-block w-100" alt="accesoires4">
                                </div>
                                <div class="carousel-item">
                                    <img src="assets/images/home/vignettes-home/achat-de-smartphone.jpg"
                                        class="d-block w-100" alt="accesoires4">
                            ...
                            <a class="carousel-control-prev" href="#carouselaccessoire4" role="button" data-slide="prev">
                                <span class="carousel-control-prev-icon" aria-hidden="true"></span>
                                <span class="sr-only">Previous</span>
                            </a>
                            <a class="carousel-control-next" href="#carouselaccessoire4" role="button" data-slide="next">
                                <span class="carousel-control-next-icon" aria-hidden="true"></span>
                                <span class="sr-only">Next</span>
                            </a>
                        </div>
        ...
        <!--EXEMPLE ACCESSOIRES-->
            <div class="container">
                <h1 class="titre text-center">
                    Quelques exemples d'accessoires
                </h1>
            </div>
